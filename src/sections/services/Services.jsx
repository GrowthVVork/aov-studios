...
export const Services = () => {
  return (
    <div className="services contained" id="services">
      <section>
        <h2>Services</h2>
          ...
          <div className="service-item-content">
            <section>
              ...
              <p>
                ...
                Day-care, office (General and Healthcare), Industrial,
                Automotive, and residential facilities, as well as multiple
                building site planning, we have successfully completed projects
                involving both new constructions and renovations of existing
                buildings.
              </p>
          ...
          <div className="service-item-content">
            <section>
              ...
              <p>
                ...
                programming and site selection, and extends throughout the
                design and construction phases. We have a deep understanding of
                the municipal agency approval processes in our region, which has
                facilitated a smoother path for many of our clients. Our
                approach emphasizes pushing the boundaries of creativity while
                maintaining a focus on practicality and utility. We recognize
                the evolving nature of the profession and strive to address key
                aspects of adapting to change.
              </p>
              <a className="more-link" href="#services">
                <span>Learn More</span>
                <img src={rightArrow} alt="More about us!" />
          ...
          <div className="service-item-content">
            <section>
              ...
              <p>
                ...
                satisfaction. Our entire firm is dedicated to going the extra
                mile when needed, ensuring that we understand our clients'
                business needs, requirements, preferences, and budget. By doing
                so, we consistently deliver highly satisfying outcomes for the
                agencies and organizations responsible for the projects.
              </p>
              <a className="more-link" href="#services">
                <span>Learn More</span>
                <img src={rightArrow} alt="More about us!" />
